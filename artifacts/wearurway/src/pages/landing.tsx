...
export default function LandingPage() {
  ...
  useEffect(() => {
    ...
    if (utm === "meta" || utm === "facebook" || utm === "paid") {
  ...
  const SlidePanel = ({ mobile, mockSettings, reals }: { mobile: boolean; mockSettings: MockSettings; reals: RealSettings[] }) => (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden", display: "flex", flexDirection: "column" }}>
      ...
      {mobile && (
        <>
          <div style={{ position: "absolute", top: 0, left: 0, right: 0, height: "10vh", zIndex: 5, pointerEvents: "none", background: "linear-gradient(to bottom, #000000, transparent)" }} />
          <div style={{ position: "absolute", bottom: 0, left: 0, right: 0, height: "10vh", zIndex: 5, pointerEvents: "none", background: "linear-gradient(to top, #000000, transparent)" }} />
        </>
      )}
    </div>
  );
  ...
  return (
    <div style={{ position: "fixed", inset: 0, background: "#000000", fontFamily: "'Barlow Condensed', sans-serif", overflow: "hidden" }}>
      ...
      <div className="flex md:hidden" style={{ position: "absolute", inset: 0 }}>
        ...
        <div style={{ position: "absolute", top: `${mockMobile.textY}%`, left: 0, right: 0, zIndex: 20, transform: "translateY(-50%)", padding: "16px 0" }}>           <div style={{ position: "absolute", top: "-8vh", left: 0, right: 0, height: "8vh", pointerEvents: "none", background: "linear-gradient(to top, #000000 0%, #000000 20%, rgba(0,0,0,0.8) 50%, transparent 100%)" }} />
          ...
          <div style={{ position: "absolute", bottom: "-20vh", left: 0, right: 0, height: "20vh", pointerEvents: "none", background: "linear-gradient(to bottom, #000000 0%, #000000 20%, rgba(0,0,0,0.8) 50%, transparent 100%)" }} />
        </div>
      </div>
