...
>
  ...
  <button
    ...
    className="absolute bottom-4 left-4 z-20 hidden md:flex items-center gap-3 px-4 py-3 rounded-2xl transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg"
    style={{
