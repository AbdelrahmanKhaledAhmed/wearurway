...
export default function ImageEditor({ file, onConfirm, onCancel, qualityScale=1, showBgHint=false }: Props) {
  ...
  <button
    ...
    className="absolute bottom-0 left-0 right-0 z-20 w-full flex items-center gap-3 px-4 py-3 transition-all active:opacity-90 hover:opacity-95"
  ...
  >
    ...
    <span className="text-[11px] font-semibold leading-snug text-left">
      Need help?{" "}
      <span className="font-black">
        We'll turn your idea into exactly what you imagine.
      </span>
    </span>
  </button>
)}
