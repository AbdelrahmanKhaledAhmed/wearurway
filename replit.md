...
- Live print dimensions for selected layers are calculated from the ratio-locked layer width and natural image aspect ratio so width and height update proportionally during resizing.
